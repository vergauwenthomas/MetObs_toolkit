...
The MetObs-toolkit provides a comprehensive framework for scientists to process raw meteorological data for analysis by making intensive use of the functionalities from pandas [@pandas] and geopandas [@geopandas] libraries. The process consists of the following steps, visualized in the \autoref{fig:overview_fig}.
