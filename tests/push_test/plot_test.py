...
dataset.make_plot()
dataset.make_plot(obstype='humidity',stationnames=['vlinder02', 'vlinder17'], legend=False)
...
dataset.make_geo_plot(obstype='wind_direction', timeinstance=datetime(2022,9,5,12,0))