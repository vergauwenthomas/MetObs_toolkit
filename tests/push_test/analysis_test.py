...
temp_diurnal = an.get_diurnal_statistics(colorby='lcz', stations=teststa, startdt=startdt)
...
temp_diurnal_test = {'Low plants (LCZ D)': {0: 15.539583333333333,
