...
def check_template_compatibility(template, df_columns):
    ...
    unmapped_assumed = [
        templ_var for templ_var in assumed_cols if not templ_var in present_cols
    ]
...
def import_data_from_csv(
    input_file, template_file, long_format, obstype, obstype_units, obstype_description
):
