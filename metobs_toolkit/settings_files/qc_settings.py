...
checks_info = {
    # 1. --> on data import
    "duplicated_timestamp": {
        "label_columnname": "duplicated_timestamp_label",
    ...
    # 2. --> on data import
    "invalid_input": {
        "label_columnname": "invalid_input_label",
    ...
    "gross_value": {
        "label_columnname": "gross_value_label",  # Obstype_ is prefix
    ...
    "persistance": {
        "label_columnname": "persistance_label",  # Obstype_ is prefix
    ...
    "repetitions": {
        "label_columnname": "repetitions_label",  # Obstype_ is prefix
    ...
    "step": {
        "label_columnname": "step_label",  # Obstype_ is prefix
        "outlier_flag": "in step outlier group",
        "numeric_flag": 7,
        "apply_on": "obstype",
    },
    "window_variation": {
        "label_columnname": "window_variation_label",  # Obstype_ is prefix
