...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 11 09:53:59 2024
...
class Dataset(Dataset):
    """Extension on the metobs_toolkit.Dataset class with Quality control techniques"""
    ...
    def _find_duplicates_on_import(self):
        ...
        # update the applied qc records
        self._applied_qc = concat_save(
            [
                self._applied_qc,
                conv_applied_qc_to_df(
                    obstypes=self._get_present_obstypes(),
                    ordered_checknames=["duplicated_timestamp"],
                ),
            ],
            ignore_index=True,
        )
