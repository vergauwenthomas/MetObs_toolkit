...
label_def = {
    ...
    "gross_value": {"label": "gross value outlier", "color": "#f1ff2b", "numeric_val": 3},
    "persistence": {"label": "persistence outlier", "color": "#f0051c", "numeric_val": 4},
    "repetitions": {"label": "repetitions outlier", "color": "#056ff0", "numeric_val": 5},
    ...
    "buddy_check": {"label": "buddy check outlier", "color": "#8300c4", "numeric_val": 8},
    ...
    "interpolated_gap": {"label": "interpolation", "color": "#d406c6", "numeric_val": 12},
    "failed_interpolation_gap": {"label": "failed interpolation", "color": "#d406c6", "numeric_val": 13},
    # ----- raw model gapfill -----
    "raw_modeldata_fill": {"label": "raw modeldata fill", "color": "#6e1868", "numeric_val": 14},
    ...
    "debias_modeldata_fill": {"label": "debiased modeldata fill", "color": "#6e1868", "numeric_val": 16},
...
label_to_numeric_map = {group["label"]: group["numeric_val"] for group in label_def.values()}
