...
vlinder_metadata_db_template = {
        'VLINDER': {'varname': 'name',
                    'dtype': 'object'},
        'ID':  {'varname': 'id',        #for merging
                    'dtype': 'object'},
        
        'Location': {'varname': 'call_name',
                    'dtype': 'object'},
...
vlinder_observations_db_template = {
        ...
        'StationID':  {'varname': 'id',        #for merging
                    'dtype': 'object'},
        ...
        'RainIntensity': {'varname':'precip',
                                'units': r'l/m$^2 per ?? tijdseenheid$',
                                'dtype': 'float64',
                                'description': 'precipitation intensity'},
        'RainVolume': {'varname':'precip_sum', 
                        'units': r'l/m^2',
                        'dtype': 'float64',
                        'description': 'precipitation cumulated from midnight'},
        'WindDirection': {'varname': 'wind_direction',
                         'units': r'° from North (CW)',
                         'dtype': 'float64',
                         'description': 'Wind direction'},
        'WindSpeed': {'varname':'wind_speed',
                         'units': r'm/s',
                         'dtype': 'float64',
                         'description': 'windspeed'},
        'WindGust': {'varname': 'wind_gust',
                    'units': r'm/s',
                    'dtype': 'float64',
                    'description': 'windgust'},
        'pressure_0': {'varname': 'pressure_at_sea_level',
                                'units': 'pa',
                                'dtype': 'float64',
                                'description': 'pressure at sea level'},
        'BlackGlobeTemp': {'varname': 'radiation_temp',
